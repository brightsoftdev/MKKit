...
//  MKKit
//
//  Created by Matthew King on 2/20/12.
 ...
 *Overview*
 ...
 The NSString Catagory class creates specaillty strings such as number and date formats, paths, and UUIDs. You 
 have the choice to use instance methods or class methods for all strings.
-----------------------------------------------------------------------------------------------------*/

@interface NSString (MKKit)
